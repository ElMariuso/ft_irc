...
class Command
{
    public:
        ...
        void                        mode(const Server &server, Client *src, const std::string &destName, const std::string &modes) const;
        ...
        void                        modeAdd(const std::string &serverName, const std::string &srcName, const std::string &destName, Client *src, const Server &server, const std::string &modes) const;
