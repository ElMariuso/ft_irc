...
/*   Updated: 2023/08/03 14:32:05 by mthiry           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Command
{
    public:
        ...
        void                        kick(const Server &server, const Client &src, const std::string &destName, const std::string &message, const std::string &channelName) const;
